...
namespace Michsky.UI.Reach
{
    ...
    public class ControllerManager : MonoBehaviour
    {
        ...
        [HideInInspector] public int currentSceneManagerIndex;
        ...
        void CheckForEmptyObject()
        {
            ...
            else if (gamepadHotkey.triggered && sceneManagers.Count != 0)
            {
                // SelectUIObject(sceneManagers[currentSceneManagerIndex].scenes[sceneManagers[currentSceneManagerIndex].currentSceneIndex].firstSelected);
            }
        }
        ...
        {
            if ((EventSystem.current.currentSelectedGameObject == null || !EventSystem.current.currentSelectedGameObject.gameObject.activeInHierarchy) && panels.Count != 0)
            {
                SelectUIObject(panels[currentManagerIndex].panels[panels[currentManagerIndex].currentPanelIndex].firstSelected);
            }
            else if ((EventSystem.current.currentSelectedGameObject == null || !EventSystem.current.currentSelectedGameObject.gameObject.activeInHierarchy) && sceneManagers.Count != 0)
            {
                // SelectUIObject(sceneManagers[currentSceneManagerIndex].scenes[sceneManagers[currentSceneManagerIndex].currentSceneIndex].firstSelected);
            }
        }
